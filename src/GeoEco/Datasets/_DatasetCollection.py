...
class DatasetCollection(CollectibleObject):
    ...
    def _GetQueryExpressionParser(cls):
        ...
        if not hasattr(DatasetCollection, '_QueryExpressionParser'):
            ...
            # Import pyparsing and enable "packrat" mode for higher
            # performance.

            from pyparsing import CaselessKeyword, CaselessLiteral, Combine, DelimitedList, nums, one_of, OpAssoc, infix_notation, Opt, ParserElement, QuotedString, Regex, Word
