    ...
    def Initialize(cls, loggingQueue=None, revertPathChanges=False):
        ...
        try:
            ...
            try:
                ...
                raise RuntimeError(_('Failed to import the GeoEco.Matlab._Matlab Python module. This may indicate an installation or configuration problem with MATLAB R2026a or the MATLAB Runtime R2026a. "import GeoEco.Matlab._Matlab" failed with %(e)s: %(msg)s') % {'e': e.__class__.__name__, 'msg': e})

            _LogDebug('Importing matlab.')
            try:
                import matlab
            except Exception as e:
                raise RuntimeError(_('Failed to import the matlab Python module. This may indicate an installation or configuration problem with MATLAB R2026a or the MATLAB Runtime R2026a. "import matlab" failed with %(e)s: %(msg)s') % {'e': e.__class__.__name__, 'msg': e})
            ...
            try:
                ...
                raise RuntimeError(_('Failed to initialize the GeoEco.Matlab._Matlab Python module. This may indicate an installation or configuration problem with MATLAB R2026a or the MATLAB Runtime R2026a. "GeoEco.Matlab._Matlab.initialize()" failed with %(e)s: %(msg)s') % {'e': e.__class__.__name__, 'msg': e})
